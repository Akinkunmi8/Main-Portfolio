...
namespace MyPortivolio.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnurl= null)
        {
            ...
            {
                var user = new UserModel { Name = model.Name, Email = model.Email, UserName = model.UserName };
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if(user == null)
                {
                    return RedirectToAction("ForgotPasswordViewModel");
                }
        ...
        // action for forgot password confirmation
        [HttpGet]
